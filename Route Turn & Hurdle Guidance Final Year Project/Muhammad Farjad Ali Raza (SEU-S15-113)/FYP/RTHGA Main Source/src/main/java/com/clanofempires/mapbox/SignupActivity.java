    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Matcher matcher = pattern.matcher(inputEmail.getText().toString().trim());
            ...
            //check if its gmail address
                    if(email.substring(email.indexOf("@")+1).matches("gmail.com")){
                    ...
                    auth.createUserWithEmailAndPassword(email, password)
                        ...
                        Toast.makeText(getApplicationContext(),"Not a valid gmail address...",Toast.LENGTH_SHORT).show();
